...
namespace QwickFoodzStack
{
    public static class Operations
    {
        ...
        //static lists
        public static CustomStack<CustomerDetails> customersList = new CustomStack<CustomerDetails>();
        public static CustomStack<FoodDetails> foodsList = new CustomStack<FoodDetails>();
        public static CustomStack<OrderDetails> ordersList = new CustomStack<OrderDetails>();
        public static CustomStack<ItemDetails> itemsList = new CustomStack<ItemDetails>();
        public static void AddDefaultData()
        {
            ...
            foodsList.PushRange(new CustomStack<FoodDetails> { food1, food2, food3, food4, food5, food6, food7, food8, food9, food10, food11 });
            ...
            itemsList.PushRange(new CustomStack<ItemDetails> { item1, item2, item3, item4, item5, item6, item7, item8, item9, item10 });
        ...
        public static void OrderFood()
        {
            ...
            CustomStack<ItemDetails> localItemList = new CustomStack<ItemDetails>();
            ...
            if (choice.Equals("yes"))
            {
                while (choice.Equals("yes"))
                {
                    ...
                    if (currentLoggedInUser.WalletBalance >= totalPrice)
                    {
                        ...
                        itemsList.PushRange(localItemList);
                        ordersList.Add(order);
